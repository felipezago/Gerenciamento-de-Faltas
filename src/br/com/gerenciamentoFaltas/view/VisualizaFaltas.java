...
public class VisualizaFaltas extends javax.swing.JFrame {
    ...
    static List<Materias> listaCombo= new ArrayList<>();
    static List<Materias> lista= new ArrayList<>();
    static List<Materias> listaQuant= new ArrayList<>();
    static List<Materias> listaFaltas= new ArrayList<>();
    static List<Integer> qt= new ArrayList<>();
    ...
    public static void validaQuant(){
        ...
        try {
            listaQuant = MateriasDAO.selectDB();
            int auxiliar = 0;

            while (auxiliar != tbFaltas.getRowCount()) {
                Materias mat = lista.get(auxiliar);
                ...
                int at;
                    ...
                    if(quant < 10 && quant > 0){
                        ...
                        + " <html><font color=red face=arial><b>FALTAS PARA REPROVAR NA MATÉRIA: <html><font color=blue face=arial><b>"
                                + "'' " + mat.getNome_materia().toUpperCase() + " ''",
...
//                int aux= 0;
//                while(aux != listaFaltas.size()){
//                    
//                    aux++;
//                }
//                
//                JOptionPane.showMessageDialog(null, "Lista de matérias que estão prestes a reprovar: "+listaFaltas+", lista de quantidade de faltas resantes (em ordem): "+qt+"");
//                
//                System.out.println(listaFaltas);
...
//            }
    ...
    public void atualizaTabelaPesq(String sql){
        try {
            lista= MateriasDAO.pesquisa(sql);
    ...
    public void atualizaTabelaQtMax(){
        try {
            lista= MateriasDAO.ordenarQtMax();
    ...
    public void atualizaTabelaQtAtual(){
        try {
            lista= MateriasDAO.ordenarQtAtual();
    ...
    public void preencheCombo(){
        try {
            listaCombo= MateriasDAO.pesquisarCombo();
            for(Materias mat: listaCombo){
                cbMat.addItem(mat.getNome_materia());
            }
        } catch (SQLException ex) {
            ex.printStackTrace();
        }
    ...
    private void initComponents() {
        ...
        lblAdd.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/gerenciamentoFaltas/icones/add.png"))); // NOI18N
        ...
        lblRemover.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/gerenciamentoFaltas/icones/delete.png"))); // NOI18N
        ...
        lblOrder.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/gerenciamentoFaltas/icones/sort-from-a-to-z-in-alphabetical-ascending-order - Copia.png"))); // NOI18N
        ...
        lblPesq.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/gerenciamentoFaltas/icones/magnifier.png"))); // NOI18N
        ...
        lblVolta.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/gerenciamentoFaltas/icones/arrow_rotate_clockwise.png"))); // NOI18N
        ...
        lblOk.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/gerenciamentoFaltas/icones/checked (1).png"))); // NOI18N
        ...
        try{
            while(Integer.parseInt(opc)!= 2 || Integer.parseInt(opc)!= 4){
                ...
                if(Integer.parseInt(opc)== 2 || Integer.parseInt(opc)== 4 && Integer.parseInt(opc)!= 3){
                    Materias mat= lista.get(tbFaltas.getSelectedRow());
                    MateriasDAO.adicionarFaltas(Integer.parseInt(opc), mat.getId_materias());
                    break;
    ...
    private void formWindowGainedFocus(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowGainedFocus
        ...
        if(rdMat.isSelected()){
            atualizaTabelaMat();
        }else if(rdQtMax.isSelected()){
            atualizaTabelaQtMax();
        }else if(rdQtAtual.isSelected()){
        ...
        try{
            while(Integer.parseInt(opc)!= 2 || Integer.parseInt(opc)!= 4){
                ...
                if(Integer.parseInt(opc)== 2 || Integer.parseInt(opc)== 4 && Integer.parseInt(opc)!= 3){
                    ...
                    if(auxiliar >= 0){       
                        MateriasDAO.removerFaltas(Integer.parseInt(opc), mat.getId_materias());
                    }else{
